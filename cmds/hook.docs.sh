...
#   - exported variable: $runtime_solos: The private SSH key for the dev-os servers.
#   - exported variable: $runtime_solos_pub: The public SSH key for the dev-os servers.
...
#   - exported variable: $repo_dir: The SolOS repo directory.
...
#   - exported variable: $runtime_outer_working_dir: The directory where apps and . code lives.
#   - exported variable: $runtime_outer_apps_dir: The directory where apps live.
#   - exported variable: $runtime_outer_github_dir: The directory where . code lives.
...
#   - exported function: $fn_print_line: A function that prints a line the width of the user's terminal. Useful for displaying some forms of data.
