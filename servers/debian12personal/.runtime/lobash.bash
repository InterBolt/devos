...
# Version: 0.6.0 (37b4cf6b1297fcd3d5a9f1d935135e60d013b7d3)
# Prefix: l.
# Bash Minimum Version: 4.4
# UNIQ_KEY: 0_6_0_149467778_23030
# Included Modules: array_include array_include.s array_reverse ask ask_input ask_with_cancel basename basename.p benchmark choose compose count_file_lines count_files count_lines.p cur_function_name cursor_col cursor_pos cursor_row date detect_os dirname dirname.p each each.p echo_array echo echo.p echo_screen end_with end_with.s extname extname.p extract first has has_not has_not.s has.s head hex_to_rgb hostname if inc is_array is_array.s is_bash is_bash.s is_dir is_dir.s is_empty_dir is_executable is_executable_file is_executable_file.s is_executable.s is_exported is_falsy is_falsy.s is_file is_file.s is_float is_float.s is_function is_function.s is_gnu_sed is_integer is_integer.s is_link is_link.s is_number is_number.s is_readable is_readable.s is_truthy is_truthy.s is_tty_available is_tty_available.s is_ubuntu is_undefined is_writable is_writable.s join keys last lower_case lower_case.p lower_first lower_first.p match match_list normalize normalize.p not.s not.s.p now now_s parse_params pwd random read_array relative repeat rgb_to_hex sedi seq sleep sort split start_with start_with.s str_include str_include.s str_len str_replace_all str_replace str_replace_last str_size sub term_size trace_count trace_end trace_stack trace_start trace_time trap_error trim trim_color trim_color.p trim_end trim_end.p trim.p trim_start trim_start.p union_array upper_case upper_case.p upper_first upper_first.p with_ifs xdg_config_home

######################## Lobash Internals ########################

_lobash.0_6_0_149467778_23030_detect_os() {
  local kernel_name
  kernel_name="$(uname -s)"
...
[[ -n ${_LOBASH_0_6_0_149467778_23030_INTERNAL_FUNC_PREFIX:-} ]] && return

readonly _LOBASH_0_6_0_149467778_23030_INTERNAL_FUNC_PREFIX=_lobash.
readonly _LOBASH_0_6_0_149467778_23030_INTERNAL_CONST_PREFIX=_LOBASH_
readonly _LOBASH_0_6_0_149467778_23030_PRIVATE_FUNC_PREFIX=_l.
readonly _LOBASH_0_6_0_149467778_23030_PRIVATE_CONST_PREFIX=_L_
readonly _LOBASH_0_6_0_149467778_23030_PUBLIC_FUNC_PREFIX=l.
readonly _LOBASH_0_6_0_149467778_23030_PUBLIC_CONST_PREFIX=L_

readonly _LOBASH_0_6_0_149467778_23030_PREFIX=l.
_LOBASH_0_6_0_149467778_23030_PUBLIC_DEPTH=1 # NOTE: _LOBASH_0_6_0_149467778_23030_PUBLIC_DEPTH should not be readonly
readonly _LOBASH_0_6_0_149467778_23030_MIN_BASHVER=4.4

_LOBASH_0_6_0_149467778_23030_OS=$(_lobash.0_6_0_149467778_23030_detect_os)
readonly _LOBASH_0_6_0_149467778_23030_OS

_lobash.0_6_0_149467778_23030_is_bash() {
  [[ -n "${BASH_VERSION:-}" ]]
}

_lobash.0_6_0_149467778_23030_check_os() {
  if [[ ! $_LOBASH_0_6_0_149467778_23030_OS =~ ^(Linux|MacOS|BSD)$ ]]; then
    echo "Not support current system: $_LOBASH_0_6_0_149467778_23030_OS" >&2
    return 5
  fi
}

_lobash.0_6_0_149467778_23030_check_shell() {
  if ! _lobash.0_6_0_149467778_23030_is_bash; then
    echo 'Lobash only work in Bash.' >&2
    return 6
  fi
}

_lobash.0_6_0_149467778_23030_check_supported_bash_version() {
  local info
  read -r -d '.' -a info <<<"$_LOBASH_0_6_0_149467778_23030_MIN_BASHVER"
  if ((BASH_VERSINFO[0] < info[0])) ||
    ( ((BASH_VERSINFO[0] == info[0])) && ((BASH_VERSINFO[1] < info[1]))); then
    echo "Bash $BASH_VERSION is not supported. Upgrade your Bash to $_LOBASH_0_6_0_149467778_23030_MIN_BASHVER or higher version." >&2
    return 7
  fi
}

_lobash.0_6_0_149467778_23030_check_support() {
  _lobash.0_6_0_149467778_23030_check_os
  _lobash.0_6_0_149467778_23030_check_shell
  # _lobash.0_6_0_149467778_23030_check_supported_bash_version
}
...
_lobash.0_6_0_149467778_23030_dirname() {
  local str=${1:-}
  [[ $str == '/' ]] && echo '/' && return 0
  [[ $str =~ ^'../' ]] && echo '.' && return 0
  [[ ! $str =~ / ]] && echo '.' && return 0
...
_lobash.0_6_0_149467778_23030_with_IFS() {
  local IFS=$1
  shift
  eval "$*"
}

_lobash.0_6_0_149467778_23030_is_tty_available() {
  { : >/dev/tty; } &>/dev/null
}

_lobash.0_6_0_149467778_23030_is_gnu_sed() {
...
_l.0_6_0_149467778_23030_ask() {
  ...
  tty_available=$(_lobash.0_6_0_149467778_23030_is_tty_available && echo true || echo false)
...
l.ask() {
  local values=(yes no)
  _l.0_6_0_149467778_23030_ask "$1" "${2:-}"
}
...
_l.0_6_0_149467778_23030_run_benchmark() {
  local c=$1
  local repeats=$2
  local i
...
l.benchmark() {
  ...
  time _l.0_6_0_149467778_23030_run_benchmark "$c" "$repeats"

  printf '\n--------------------------\n\n'
}

_l.0_6_0_149467778_23030_choose_prompt() {
  printf '  %s\n' 'No. Item'
  local i
  for i in "${!items[@]}"; do
    printf -- '- %-2d  %s\n' $((i + 1)) "${items[$i]}"
...
l.choose() {
  ...
  local num prompt
  prompt=$(_l.0_6_0_149467778_23030_choose_prompt)
  read -r -p "$prompt" num
...
l.cur_function_name() {
  # _LOBASH_0_6_0_149467778_23030_PUBLIC_DEPTH=1 in built lobash.bash, and _LOBASH_0_6_0_149467778_23030_PUBLIC_DEPTH=2 in test.
  printf '%s\n' "${FUNCNAME[$_LOBASH_0_6_0_149467778_23030_PUBLIC_DEPTH]}"
}
...
l.dirname() {
  _lobash.0_6_0_149467778_23030_dirname "${1:-}"
}

l.dirname.p() {
  local str
  IFS='' read -r str
  _lobash.0_6_0_149467778_23030_dirname "$str"
}
...
l.is_bash.s() {
  _lobash.0_6_0_149467778_23030_is_bash && echo true || echo false
}
...
l.is_tty_available.s() {
  _lobash.0_6_0_149467778_23030_is_tty_available && echo true || echo false
}
...
if ((BASH_VERSINFO[0] > 4)); then
  ...
  _l.0_6_0_149467778_23030_perl_now() {
  ...
  l.now() {
    ...
    if [[ $_LOBASH_0_6_0_149467778_23030_OS == 'MacOS' ]]; then
...
_l.0_6_0_149467778_23030_parse_single_hyphen_options() {
  local param=${1#-}
...
_l.0_6_0_149467778_23030_parse_double_hyphen_options() {
  local param=${1#--}
...
_l.0_6_0_149467778_23030_parse_params_add_none() {
  return 0
}

_l.0_6_0_149467778_23030_parse_params_add_opt() {
  # shellcheck disable=1087
  eval "$opts_name[\$1]=\"\$2\""
}

_l.0_6_0_149467778_23030_parse_params_add_arg() {
  eval "$args_name+=(\"\$1\")"
}
...
l.parse_params() {
  ...
  if [[ $1 != _ ]]; then
    local opts_name=$1
    add_opt=_l.0_6_0_149467778_23030_parse_params_add_opt
  else
    add_opt=_l.0_6_0_149467778_23030_parse_params_add_none
  fi

  if [[ $2 != _ ]]; then
    local args_name=$2
    add_arg=_l.0_6_0_149467778_23030_parse_params_add_arg
  else
    add_arg=_l.0_6_0_149467778_23030_parse_params_add_none
  fi
  ...
  for ((i = 3; i <= param_size; i++)); do
    ...
    if l.start_with "$param" '-'; then
      ...
      if l.start_with "$param" '--'; then
        f=_l.0_6_0_149467778_23030_parse_double_hyphen_options
      else
        f=_l.0_6_0_149467778_23030_parse_single_hyphen_options
      fi
...
if _lobash.0_6_0_149467778_23030_is_gnu_sed; then
  l.sedi() { sed -i'' "$@"; }
else
  l.sedi() { sed -i '' "$@"; }
fi
...
l.sleep() {
  ...
  if [[ $OSTYPE =~ darwin ]]; then
    ...
    if [[ ! -p ${_L_0_6_0_149467778_23030_SLEEP_TEMP:-} ]]; then
      # Get available temp file path
      _L_0_6_0_149467778_23030_SLEEP_TEMP=$(mktemp -u)
      # Create a FIFO special file
      mkfifo -m 700 "$_L_0_6_0_149467778_23030_SLEEP_TEMP"
    fi

    exec {_sleep_fd}<>"$_L_0_6_0_149467778_23030_SLEEP_TEMP"
  else
    exec {_sleep_fd}<> <(true)
  fi
...
_l.0_6_0_149467778_23030_split() {
  local -i i
...
l.split() {
  ...
  if [[ $2 == '-' ]]; then
    ...
    IFS=$'\n' readarray -t "$output" < <(_l.0_6_0_149467778_23030_split)
  fi
}
...
l.trace_count() {
  local label=${1:-trace}
  local key=_LOBASH_0_6_0_149467778_23030_trace_count_$label
...
l.trace_end() {
  set +o xtrace
  PS4=${_L_0_6_0_149467778_23030_TRACE_OLD_PS4:-$PS4}
}
...
l.trace_stack() {
  ...
  local i
  # _LOBASH_0_6_0_149467778_23030_PUBLIC_DEPTH=1 in built lobash.bash, and _LOBASH_0_6_0_149467778_23030_PUBLIC_DEPTH=2 in test.
  for i in $(seq "$_LOBASH_0_6_0_149467778_23030_PUBLIC_DEPTH" $((${#FUNCNAME[@]} - 1))); do
    printf -- '  - %s (%s:%s)\n' "${FUNCNAME[$i]}" "${BASH_SOURCE[$i]:-(shell)}" "${BASH_LINENO[$i]}"
  done
}

l.trace_start() {
  read -r _L_0_6_0_149467778_23030_TRACE_OLD_PS4 <<<"$PS4"
  local label=${2:-}
  [[ -n "$label" ]] && label="[$label]"
...
l.trace_time() {
  local label=${1:-debug}
  local key=_LOBASH_0_6_0_149467778_23030_TRACE_TIME_$label
  local last_time=${!key:-}
  local current
  current="$(l.now)"
...
_l.0_6_0_149467778_23030_trap_error() {
...
l.trap_error() {
  local trap_func=${1:-_l.0_6_0_149467778_23030_trap_error}
...
_L_0_6_0_149467778_23030_TRIM_COLOR_ECS=$'\e'
_L_0_6_0_149467778_23030_TRIM_COLOR_ECS2=$'\u001b'
if [[ "$_L_0_6_0_149467778_23030_TRIM_COLOR_ECS" == "$_L_0_6_0_149467778_23030_TRIM_COLOR_ECS2" ]]; then
  if [[ $_LOBASH_0_6_0_149467778_23030_OS == Linux ]]; then
    _L_0_6_0_149467778_23030_TRIM_COLOR_REGEX=$_L_0_6_0_149467778_23030_TRIM_COLOR_ECS
  elif [[ $_LOBASH_0_6_0_149467778_23030_OS == MacOS ]] || [[ $_LOBASH_0_6_0_149467778_23030_OS == BSD ]]; then
    _L_0_6_0_149467778_23030_TRIM_COLOR_REGEX="\\$_L_0_6_0_149467778_23030_TRIM_COLOR_ECS"
  fi
else
  if [[ $_LOBASH_0_6_0_149467778_23030_OS == Linux ]]; then
    _L_0_6_0_149467778_23030_TRIM_COLOR_REGEX="($_L_0_6_0_149467778_23030_TRIM_COLOR_ECS|\\$_L_0_6_0_149467778_23030_TRIM_COLOR_ECS2)"
  elif [[ $_LOBASH_0_6_0_149467778_23030_OS == MacOS ]] || [[ $_LOBASH_0_6_0_149467778_23030_OS == BSD ]]; then
    _L_0_6_0_149467778_23030_TRIM_COLOR_REGEX="(\\$_L_0_6_0_149467778_23030_TRIM_COLOR_ECS|\\$_L_0_6_0_149467778_23030_TRIM_COLOR_ECS2)"
  fi
fi
...
l.trim_color() {
  ( (($# == 0)) || [[ -z ${1:-} ]]) && echo '' && return
  sed -E "s,${_L_0_6_0_149467778_23030_TRIM_COLOR_REGEX}[[0-9]*(;[0-9]+)*m,,g" <<<"$1"
}
...
_l.0_6_0_149467778_23030_union_array() {
...
l.union_array() {
  ...
  eval "for l_union_array_item in \"\${${1}[@]}\"; do _l.0_6_0_149467778_23030_union_array; done || true"

  if (($# > 1)); then
    eval "for l_union_array_item in \"\${${2}[@]}\"; do _l.0_6_0_149467778_23030_union_array; done || true"
  fi
